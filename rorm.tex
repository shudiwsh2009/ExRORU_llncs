...
By looking into the executing semantics of these models, we find that the introduction of invisible tasks influences the adjacency of transitions, i.e., $I$ can be directly followed by $O$ in Fig. \ref{fig:sdaExampleA}. In order to solve the problem of invisible task, we propose the concept of sequential direct adjacency.
