...
\subfigure[] {
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{fig_concurrent_case_b.eps}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{fig_concurrent_case_c.eps}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth]{fig_concurrent_case_d.eps}
	\end{minipage}
...
\begin{figure}[htbp]
	\begin{minipage}[b]{0.5\textwidth}
		...
		\subfigure[] {
			\centering
			\includegraphics[width=1\textwidth]{fig_sda_example_1.eps}
			\label{fig:sdaExampleA}
		}
		\subfigure[] {
			\centering
			\includegraphics[width=1\textwidth]{fig_sda_example_2.eps}
...
Let $\Sigma=(P,T,F,M_{0})$ be a WF-net and $A,B\in T$ are two visible transitions. $A$ and $B$ are in sequential direct adjacency iff:
	...
	\end{itemize}
$A\rightarrow_{D}B$ if they are in sequential direct adjacency while $A\rightarrow_{N}B$ if not. The set of all the transition pair which are in sequential direct adjacency is the SDA-set of a model.
\end{definition}
...
\subsection{The Importance of Relations}\label{subsec:importance}
When we measure the similarity between two models, we actually maesure the similarity between the relations of them. However, the importance of relations should not be the same as each other. Take $I\twoheadrightarrow D$ and $I\rightharpoonup A$ in Fig. \ref{fig:examplePetri} for example, %TODO
