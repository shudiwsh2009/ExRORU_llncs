...
Before presenting the experimental results of our algorithm, we want to show some special examples such as WF-nets with non-free-choice structures and multi-relations. Examples in this section together with the models in Figure \ref{fig:sdaExample} show the powerful capability of our algorithm to present the behaviors of a process model.

\begin{figure}[ht]
\label{fig:exampleNFC}
\caption{A WF-net with non-free-choice structure}
\end{figure}

Figure \ref{fig:exampleNFC} shows a WF-net with non-free-choice structure. 
