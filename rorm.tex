...
\textbf{Experiment Models} As shown in Figure \ref{fig:property1}, make the number of transitions be $10$ in $N1$, then add a new transition to $11$ intervals including the beginning and the end. Thus we obtain $N2-N12$, totally $11$ models. The similarity results are shown in Figure \ref{fig:property1comp}.
