...
\subfigure[A sound WF-net] {
	\centering
	\includegraphics[width=0.7\textwidth]{fig_example_petri.eps}
	\label{fig:examplePetri}
}
\subfigure[The complete prefix unfolding of \subref{fig:examplePetri}] {
	\centering
	\includegraphics[width=0.7\textwidth]{fig_example_cpu.eps}
...
\subfigure[A WF-net with multi-relation constructs] {
	\centering
	\includegraphics[width=0.8\textwidth]{fig_multi_rel.eps}
	\label{fig:multiRelExample}
}
\subfigure[The complete prefix unfolding of \subref{fig:multiRelExample}] {
	\centering
	\includegraphics[width=0.8\textwidth]{fig_multi_rel_cpu.eps}
...
Table \ref{tab:summary} gives an overview of the quality evaluation on existing algorithms. Our algorithm ExRORU is the only one which satisfies all the five properties.
...
\hline
 Algorithm &Property1&Property2&Property3&Property4&Property5\\ \hline
 TAR &\texttimes&\texttimes&\checkmark&\texttimes&\texttimes \\ 
 PTS &\checkmark&\checkmark&\checkmark&\texttimes&\checkmark\\ 
 CFS &\checkmark&\checkmark&\checkmark&\checkmark&\checkmark\\
 BP  &\checkmark&\texttimes&\checkmark&\checkmark&\checkmark \\
 ExRORU &\checkmark&\checkmark&\checkmark&\checkmark&\checkmark\\ \hline
\end{tabular}
\end{table}
