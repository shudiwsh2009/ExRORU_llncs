...
% 		\subfigure[] {
% 			\centering
% 			\includegraphics[width=0.8\textwidth]{fig_sda_example_1.eps}
% 		}
% 		\subfigure[] {
% 			\centering
% 			\includegraphics[width=0.8\textwidth]{fig_sda_example_2.eps}
% 		}
...
% 				\\ \hline
% 		\end{tabular}
% 		\caption{Extend relations of the models in Fig. \ref{fig:sdaExample}}
