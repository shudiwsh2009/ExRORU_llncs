...
For two extended relations $R1=(\gamma_{1},\delta_{1},\theta_{1})$ and $R2=(\gamma_{2},\delta_{2},\theta_{2})$ where $R1_{pair}=R2_{pair}$,
\begin{equation}\label{eq:relationOperations}
	\begin{aligned}
		R_{1}\cap R_{2}&=
			\begin{cases}
				0~R1_{pair}&	\gamma_{1}=\gamma_{2}=\text{"N"}\vee\gamma_{1}\neq\gamma_{2}\\
		...
		R_{1}\cup R_{2}&=
			\begin{cases}
				0~R1_{pair}&	\gamma_{1}=\gamma_{2}=\text{"N"}\\
				\theta_{1}~R1_{pair}&	\gamma_{1}\neq\text{"N"}\wedge\gamma_{2}=\text{"N"}\\
				\theta_{2}~R1_{pair}&	\gamma_{1}=\text{"N"}\wedge\gamma_{2}\neq\text{"N"}\\
				\max\{\theta_{1},\theta_{2}\}~R1_{pair}&	\gamma_{1}\neq\text{"N"}\wedge\gamma_{2}\neq\text{"N"}
			\end{cases}
	\end{aligned}
\end{equation}
