...
plot 'property1.dat' u 1:2 w lp pt 1 lc "#622a1d" ps 0.6 title "TAR",\
		'property1.dat' u 1:3 w lp pt 3 lc "#801DAE" ps 0.6 title "PTS",\
		'property1.dat' u 1:4 w lp pt 11 lc "#ffa631" ps 0.5 dt 2 title "CFS",\
		'property1.dat' u 1:5 w lp pt 7 lc "#44CEF6" ps 0.5 title "BP",\
