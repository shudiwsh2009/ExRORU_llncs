...
Our experimental dataset contains real-life models from several enterprises such as TC, DG, SAP and IBM. The basic features of these models are summarized in Table \ref{tab:datasets}.
...
\begin{tabular}{|c|r|r|r|r|r|r|r|r|r|r|} \hline
	...
	IBM & 937 & 26.02 & 39.34 & 77.38 & 3 & 4 & 6 & 145 & 216 & 448 \\ \hline
\end{tabular}
\end{table}
...
Our algorithm is still not fast enough, compared to other mainstream algorithms which also ultilize the relations between tasks. On the other hand, we omit the proof of some theorems due to space limitation. We will solve these in the future.
