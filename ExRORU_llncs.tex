...
\subfigure[A sound WF-net] {
	\centering
	\includegraphics[width=0.6\textwidth]{fig_example_petri}
	\label{fig:examplePetri}
}
\subfigure[The CPU of \subref{fig:examplePetri}] {
	\centering
	\includegraphics[width=0.6\textwidth]{fig_example_cpu}
...
\subfigure[] {
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{fig_causal_case_a_1}\\
		\vspace{4pt}
		\includegraphics[width=0.9\textwidth]{fig_causal_case_a_2}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\textwidth]{fig_causal_case_b_1}\\
		\vspace{4pt}
		\includegraphics[width=0.9\textwidth]{fig_causal_case_b_2}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{1.0\textwidth}
		\centering
		\includegraphics[width=0.5\textwidth]{fig_causal_case_c_1}\\
		\vspace{4pt}
		\includegraphics[width=0.5\textwidth]{fig_causal_case_c_2}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{1.0\textwidth}
		\centering
		\includegraphics[width=0.6\textwidth]{fig_causal_case_d_1}\\
		\vspace{4pt}
		\includegraphics[width=0.6\textwidth]{fig_causal_case_d_2}
	\end{minipage}
...
\subfigure[] {
	\begin{minipage}[b]{1\textwidth}
		\centering
		\includegraphics[width=0.35\textwidth]{fig_concurrent_case_a_1}
		% \hspace{0.5in}
		\includegraphics[width=0.35\textwidth]{fig_concurrent_case_a_2}
	\end{minipage}
...
\subfigure[A WF-net with multi-relation] {
	\centering
	\includegraphics[width=0.6\textwidth]{fig_multi_rel}
	\label{fig:multiRelExample}
}
\subfigure[The CPU of the WF-net in \subref{fig:multiRelExample}] {
	\centering
	\includegraphics[width=0.6\textwidth]{fig_multi_rel_cpu}
