...
\centering
	\begin{tabular}{c|c|c|c|c|c|c|c} \hline
		...
		$D$ 
			...
			& \tabincell{c}{$\nrightarrow\nleftarrow\Uparrow$} 
			& \tabincell{c}{$\nrightarrow\nleftarrow\Uparrow$} 
			& \tabincell{c}{$\rightharpoonup\leftharpoonup\nparallel$} 
			& \tabincell{c}{$\rightharpoonup\leftharpoonup\nparallel$} 
			& \tabincell{c}{$\nrightarrow\leftharpoonup\nparallel$} 
		...
		$E$ 
			...
			& \tabincell{c}{$\nrightarrow\nleftarrow\Uparrow$} 
			& \tabincell{c}{$\nrightarrow\nleftarrow\Uparrow$} 
			& \tabincell{c}{$\twoheadrightarrow\twoheadleftarrow\nparallel$} 
			& \tabincell{c}{$\rightharpoonup\leftharpoonup\nparallel$} 
			& \tabincell{c}{$\nrightarrow\leftharpoonup\nparallel$} 
			& \tabincell{c}{$\rightharpoonup\nleftarrow\nparallel$}
			\\ \hline
...
Given two extended relation sets $RS_{h}^{P}$ and $RS_{h}^{Q}$ from two models $P$ and $Q$ with the same $h$. Then we have:
		\begin{align}\label{eq:relSetOperations}
			RS_{h}^{P}\Cap RS_{h}^{Q}= & \sum_{R_{h}^{P}\in RS_{h}^{P},R_{h}^{Q}\in RS_{h}^{Q},{R_{h}^{P}}_{pair}={R_{h}^{Q}}_{pair}}{R_{h}^{P}\cap R_{h}^{Q}}\\
			RS_{h}^{P}\Cup RS_{h}^{Q}= & \sum_{R_{h}^{P}\in RS_{h}^{P},R_{h}^{Q}\in RS_{h}^{Q},{R_{h}^{P}}_{pair}={R_{h}^{Q}}_{pair}}{R_{h}^{P}\cup R_{h}^{Q}}\\
			& +|\{R_{h}^{P}\in RS_{h}^{P}|\nexists R_{h}^{Q}\in RS_{h}^{Q},s.t.~{R_{h}^{P}}_{pair}={R_{h}^{Q}}_{pair}\}|\\
			& +|\{R_{h}^{Q}\in RS_{h}^{Q}|\nexists R_{h}^{P}\in RS_{h}^{P},s.t.~{R_{h}^{P}}_{pair}={R_{h}^{Q}}_{pair}\}|
		\end{align}
\end{definition}
