...
Examples in this section together with the models in Figure \ref{fig:drawbacks} show the powerful capability of ExRORU to represent the behaviors of a process model.
...
\caption[Scalability comparison of five algorithms]{Scalability comparison of five algorithms\label{fig:scalability}}
\end{figure}
