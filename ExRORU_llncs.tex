...
%   \centering
%   \subfigure[Breadth-scalability dataset]{
%     \label{subfig:CompBreadth}
%     \includegraphics[width=2.0in]{fig_scalability_breadth}}
%     \hspace{0.25in}
%   \subfigure[five concurrent branches in total]{
%     \label{subfig:CompDepth}
%     \includegraphics[width=2.0in]{fig_scalability_depth}}
%   \caption{Scalability comparison of BP$^+$ and BP on synthesized models}
